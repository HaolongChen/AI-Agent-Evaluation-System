...
export const ORGANIZATION_EX_ID = process.env["ORGANIZATION_EX_ID"] || "";

export const MOMEN_DOCS_URL =
  process.env["MOMEN_DOCS_URL"] || "https://docs.momen.app";
...
if (!process.env["WS_URL"] || !process.env["userToken"]) {
  throw new Error(
