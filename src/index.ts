...
import { createApplicationServiceBundle, infrastructureServiceBundle } from "./DI/service.ts";
...
const applicationServiceBundle = createApplicationServiceBundle(repositoryBundle,
