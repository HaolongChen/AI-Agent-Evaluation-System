...
import { copilotExecutionTaskCreatedEventService, type CopilotExecutionTaskCreatedEvent, type ICopilotExecutionTaskCreatedEvent } from "../domain/event/copilot-execution-task-created.event.ts";
...
export class CopilotSessionEventRegistrationService {
  constructor(
    private readonly copilotExecutionTaskCreatedEventConsumer: IDomainEventConsumer<ICopilotExecutionTaskCreatedEvent>,
  ...
  registerEventBus ( eventBus: ICopilotSessionEventBus )
  {
