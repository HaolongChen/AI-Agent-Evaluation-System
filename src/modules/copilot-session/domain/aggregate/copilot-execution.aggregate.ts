...
> {
  ...
  static createExecutionTask ( copilotServer: CopilotServerEntity, projectId: string ): CopilotExecutionAggregate
  {
    const copilotExecution = new CopilotExecutionAggregate(copilotServer, projectId);
    copilotExecution.addEvent(new CopilotExecutionTaskCreatedEvent(copilotExecution, projectId));
