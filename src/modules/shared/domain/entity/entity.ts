...
export type EntityEventList<T extends Pick<Entity, ExcludePrivateMethodsNames<keyof Entity>>> = {
...
> =
	...
	: K extends keyof z.infer<T> ? z.infer<T>[K & keyof z.infer<T>]
	: never;
...
> =
	K extends EntityKey<T, M> ? RawEntityValue<T, M, K>
